...
I18N_OPT_MANUAL="Manual start/stop -- use ./run.sh"
I18N_LABEL_SYSTEMD="systemd service (auto-start on boot)"
I18N_LABEL_MANUAL="Manual start/stop (./run.sh)"
...
I18N_GAUGE_RUNSH="Creating startup script (run.sh)..."
...
I18N_MSG_WSJTX_NOTE=$'\n\n  WSJT-X not installed -- FT8/WSPR require: sudo apt install wsjtx'
