...
> **Note on FT-991A:** The waterfall shows the AF spectrum (0–3 kHz for SSB), not wideband RF spectrum. To see activity across the full band (±50 kHz), an RTL-SDR is required — see [hardware_requirements.md](hardware_requirements.md).
