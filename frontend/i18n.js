...
const LOCALES = {
  pt: {
    ...
    clublog_hint:          "Application Password em <strong>Conta &rarr; Segurança</strong> no Clublog.",
    ...
    clublog_auto_upload:    "Enviar automaticamente cada QSO ao registar",
    clublog_missing_fields: "Preencha o Indicativo, E-mail e Palavra-passe de Aplicação.",
    btn_close:             "Fechar",
    /* Cluster DX */
  ...
  en: {
    ...
    clublog_hint:          "Application Password under <strong>Account &rarr; Security</strong> on Clublog.",
    clublog_save:          "Save",
    ...
    clublog_auto_upload:    "Automatically upload each QSO when logged",
    clublog_missing_fields: "Please fill in Callsign, E-mail and Application Password.",
    btn_close:             "Close",
    /* DX Cluster */
